...
public class Test {
	public static void main(String[] args) {
		...
		// sykanska.setSurname("Kañska");
		// sykanska.setAddress("ul. Gogoliñska 27/14");
		...
		// testWorker.setAddress("ul. Koœciuszki 6B/12");
		...
		// testLibData.setAddress("ul. Wolnoœci 177");
