...
//			return volume.getIsReserve() ? SystemProperties.getInstance().getResourceBundle().getString("volumeTableModel.isReadigRoomTrueVal")
	...
	public Object getValueAt(int row, int col) {
		...
		case COL_IS_RESERVERD:
			return volume.getIsReserve() ? SystemProperties.getInstance().getResourceBundle().getString("volumeTableModel.isReadigRoomTrueVal")
					: SystemProperties.getInstance().getResourceBundle().getString("volumeTableModel.isReadigRoomFalseVal");
		case COL_IS_LOANED:
			return volume.getIsLended() ? SystemProperties.getInstance().getResourceBundle().getString("volumeTableModel.isReadigRoomTrueVal")
					: SystemProperties.getInstance().getResourceBundle().getString("volumeTableModel.isReadigRoomFalseVal");
		default:
