...
public class AdmBookDataPanel extends JPanel {
	...
	public AdmBookDataPanel() {
		...
		JLabel lblTitle = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookTableModel.titleCol") + ":");
		...
		lblIsbnNumber = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookTableModel.isbnNumberCol") + ":");
		...
		JLabel lblNumberOfPage = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookTableModel.numberOfPageCol") + ":");
		...
		JLabel lblNumberOfTomes = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookTableModel.numberOfTomesCol") + ":");
		...
		btnClear.setIcon(new ImageIcon(new ImageIcon(RegistrationPanel.class.getResource("/images/btnClear-ico.png")).getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
