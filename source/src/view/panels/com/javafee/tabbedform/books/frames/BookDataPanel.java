...
public class BookDataPanel extends JPanel {
	...
	public BookDataPanel() {
		...
		setBorder(new TitledBorder(null, SystemProperties.getInstance().getResourceBundle().getString("bookDataPanel.bookDataPanelBorderTitle"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JLabel lblTitle = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookDataPanel.lblTitle"));
		...
		JLabel lblIsbnNumber = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookDataPanel.lblIsbnNumber"));
		...
		JLabel lblNumberOfPage = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookDataPanel.lblNumberOfPage"));
		...
		JLabel lblNumberOfTomes = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("bookDataPanel.lblNumberOfTomes"));
	...
	public JTextField getTextFieldIsbnNumber() {
		return textFieldIsbnNumber;
	}

	public void setTextFieldIsbnNumber(JTextField textFieldIsbnNumber) {
		this.textFieldIsbnNumber = textFieldIsbnNumber;
	}

	public JTextField getTextFieldNumberOfPage() {
		return textFieldNumberOfPage;
	}

	public void setTextFieldNumberOfPage(JTextField textFieldNumberOfPage) {
		this.textFieldNumberOfPage = textFieldNumberOfPage;
	}

	public JTextField getTextFieldNumberOfTomes() {
		return textFieldNumberOfTomes;
	}

	public void setTextFieldNumberOfTomes(JTextField textFieldNumberOfTomes) {
		this.textFieldNumberOfTomes = textFieldNumberOfTomes;
	}
}
