...
public class WorkerAddModFrame extends JFrame {
	...
	public WorkerAddModFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(WorkerAddModFrame.class.getResource("/images/splashScreen.jpg")));
	...
	public void setClientDataPanel(WorkerDataPanel workerDataPanel) {
		this.workerDataPanel = workerDataPanel;
	}
