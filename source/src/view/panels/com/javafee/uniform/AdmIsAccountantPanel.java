...
public class AdmIsAccountantPanel extends JPanel {
	...
	public AdmIsAccountantPanel() {
		...
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), SystemProperties.getInstance().getResourceBundle().getString("admIsAccountantPanel.admIsAccountantPanelBorderTitle"),
		...
		chckbxIsAccountant = new JCheckBox(SystemProperties.getInstance().getResourceBundle().getString("admIsAccountantPanel.chckbxIsAccountant"));
	...
	public JCheckBox getChckbxIsAccountant() {
		return chckbxIsAccountant;
	}
