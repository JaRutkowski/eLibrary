...
public class AdmIsRegisteredPanel extends JPanel {
	...
	public AdmIsRegisteredPanel() {
		...
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), SystemProperties.getInstance().getResourceBundle().getString("admIsRegisteredPanel.admIsRegisteredPanelBorderTitle"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		chckbxIsRegistered = new JCheckBox(SystemProperties.getInstance().getResourceBundle().getString("admIsRegisteredPanel.chckbxIsRegistered"));
