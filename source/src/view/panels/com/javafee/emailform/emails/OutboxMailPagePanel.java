...
public class OutboxMailPagePanel extends JPanel {
	...
	public OutboxMailPagePanel() {
		...
		lblRecipient = new JLabel(SystemProperties.getInstance().getResourceBundle().getString("outboxMailPanel.lblRecipient"));
		...
		checkShowOnlySystemCorrespondence = new JCheckBox(SystemProperties.getInstance().getResourceBundle().getString("outboxMailPanel.chckbxShowOnlySystemCorrespondence"));
